...
*Definimos una regla de desición:* Para una significancia $\alpha=0.05$, con una $\chi_c^2$ critica correspondiente, si la $\chi^2$ de la prueba estadística es mayor que $\chi_c^2$, rechazamos la hipótesis nula.
